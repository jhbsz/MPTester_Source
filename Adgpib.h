...
extern int gpib_get_globals (int* pibsta, int* piberr, int* pibcnt, long* pibcntl);
extern const char* gpib_error_string( int iberr );

/*  Funciton to get Thread-Specific copies of the GPIB global vars */
//extern int RegisterGpibGlobalsForThread(int *Uibsta, int *Uiberr, int *Uibcnt, long *Uibcntl);
//extern int UnregisterGpibGlobalsForThread();
